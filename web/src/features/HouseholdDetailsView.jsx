...
export default function HouseholdDetailsView() {
  ...
  const toggleModule = async (module) => {
    ...
    try {
      ...
      showNotification(
        `${module} module ${newModules.includes(module) ? 'enabled' : 'disabled'}.`,
        'success'
      );
    } catch {
  ...
  const EXTRA_TABS = [
            ...
            <Grid container spacing={2}>
              <Grid xs={12} md={6}>
                <FormControl>
                  ...
                  <Input
                    value={data.broadband_provider || ''}
                    onChange={(e) => handleChange('broadband_provider', e.target.value)}
                  />
                </FormControl>
              </Grid>
              <Grid xs={12} md={6}>
              ...
              <Grid xs={12} md={6}>
                <FormControl>
                  ...
                  <Input
                    value={data.smart_home_hub || ''}
                    onChange={(e) => handleChange('smart_home_hub', e.target.value)}
                  />
                </FormControl>
              </Grid>
              <Grid xs={12}>
        ...
        <form onSubmit={handleSubmit}>
          <Stack spacing={3}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid xs={12}>
                <Divider>Automated Backups</Divider>
              </Grid>
              <Grid xs={12} md={6}>
                <FormControl
                ...
                >
                  <Box>
                    ...
                    <Typography level="body-xs">
                      Nightly snapshots of the household database.
                    </Typography>
                  </Box>
                  <Switch
    ...
    },
    {
      ...
      content: (data, handleChange, handleSubmit) => (
        <Stack spacing={3}>
          <FinanceSchemaEditor metadataSchema={schemaData} onChange={setSchemaData} />
          <Box sx={{ pt: 2, display: 'flex', justifyContent: 'flex-end' }}>
            <Button onClick={handleSubmit} variant="solid" size="lg" startDecorator={<Save />}>
              Save Configuration
            </Button>
          </Box>
        </Stack>
        ...
        <Stack spacing={4}>
          <Sheet variant="outlined" sx={{ p: 3, borderRadius: 'md', bgcolor: 'background.level1' }}>
            <Typography
              level="title-md"
              sx={{ mb: 1 }}
              startDecorator={<ViewModule color="primary" />}
            >
              Feature Modules
            </Typography>
            <Typography level="body-xs" color="neutral" sx={{ mb: 3 }}>
              Disabling a module hides its associated data and prevents new entries. Existing data
              is preserved.
            </Typography>
            <Stack spacing={2}>
                ...
                >
                  <Box>
                    ...
                    <Typography level="body-xs" color="neutral">
                      Enable or disable {mod} tracking.
                    </Typography>
                  </Box>
                  <Switch
          ...
          <Sheet variant="outlined" sx={{ p: 3, borderRadius: 'md', bgcolor: 'background.level1' }}>
            <Typography
              level="title-md"
              sx={{ mb: 2 }}
              startDecorator={<CloudDownload color="primary" />}
            >
              Data Export
            </Typography>
            <Typography level="body-xs" color="neutral" sx={{ mb: 3 }}>
