                        ...
                        <Card variant="outlined" sx={{ height: '100%', display: 'flex', flexDirection: 'column', gap: 2 }}>
                            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                ...
                                <Box sx={{ textAlign: 'right' }}>
                                    {remaining > 0 ? (
                                        ...
                                        <Typography level="h3">£{agree.monthly_payment?.toLocaleString()}<Typography level="body-xs" color="neutral">/mo</Typography></Typography>
                                    )}
                                </Box>
                            </Box>
                            ...
                            <Grid container spacing={2}>
                                <Grid xs={6}>
                                    ...
                                    <Typography level="body-sm">£{agree.monthly_payment?.toLocaleString()}</Typography>
                                </Grid>
                                <Grid xs={6}>
                                    <Typography level="body-xs" color="neutral">Interest Rate</Typography>
                                    <Typography level="body-sm">{agree.interest_rate || 0}%</Typography>
                                </Grid>
                                <Grid xs={12}>
                ...
                <DialogContent>
                    <form onSubmit={handleSubmit}>
                        <Stack spacing={2} sx={{ mt: 1 }}>
                            ...
                            <Grid container spacing={2}>
                                <Grid xs={6}>
                                    <FormControl><FormLabel>Total Amount (£)</FormLabel><Input name="total_amount" type="number" step="0.01" defaultValue={editItem?.total_amount} /></FormControl>
                                </Grid>
                                <Grid xs={6}>
                                    <FormControl><FormLabel>Remaining Balance (£)</FormLabel><Input name="remaining_balance" type="number" step="0.01" defaultValue={editItem?.remaining_balance} /></FormControl>
                                </Grid>
                                <Grid xs={6}>
                                    <FormControl required><FormLabel>Monthly Payment (£)</FormLabel><Input name="monthly_payment" type="number" step="0.01" defaultValue={editItem?.monthly_payment} /></FormControl>
                                </Grid>
                                <Grid xs={6}>
