...
export default function AdminSettings() {
  ...
  const [nightlyVersionFilter, setNightlyVersionFilter] = useState(
    household?.nightly_version_filter || ''
  );
          ...
          <Stack spacing={3}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Stack direction="row" spacing={1}>
                <Button
                  variant="soft"
                  color="success"
                  startDecorator={<HealthAndSafety />}
              ...
              <Grid container spacing={2} alignItems="flex-end">
                ...
                <Grid xs={4}>
                  <Button
                    fullWidth
                    onClick={() =>
                      onUpdateHousehold({ nightly_version_filter: nightlyVersionFilter })
                    }
                  >
                    Save
                  </Button>
            ...
            <Sheet variant="outlined" sx={{ borderRadius: 'md', overflow: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                ...
                <tbody>
                  {testResults
                    .filter((r) => !nightlyVersionFilter || r.version === nightlyVersionFilter)
                    .map((r) => (
                      <tr key={r.id}>
                        <td
                          style={{
                        ...
                        >
                          <Chip size="sm" color={r.fails === 0 ? 'success' : 'danger'}>
        ...
        <TabPanel value={3}>
          <Grid container spacing={3}>
            <Grid xs={12} md={7}>
              <Stack spacing={3}>
                <Box sx={{ flex: 1 }}>
                  <Typography level="title-lg" startDecorator={<Verified color="primary" />}>
                    {APP_NAME} Household OS
                  </Typography>
                  <Typography level="body-sm" color="neutral" sx={{ mb: 2 }}>
                    Build {new Date().toISOString().split('T')[0].replace(/-/g, '.')} (Production
                    Stone)
                  </Typography>

                  <Typography level="body-md" sx={{ mb: 2, lineHeight: 1.6 }}>
                    {APP_NAME.toUpperCase()} ({APP_NAME}) is a next-generation household management
                    engine designed for absolute data privacy and multi-tenant isolation.
                  </Typography>
                  ...
                  <Sheet variant="soft" color="neutral" sx={{ p: 2, borderRadius: 'md', mb: 3 }}>
                    <Typography
                      level="body-xs"
                      component="div"
                      sx={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: 1 }}
                    >
                ...
                <Box>
                  ...
                  <Typography level="body-xs" sx={{ lineHeight: 1.6 }}>
                    <b>Lead Architect:</b> Matt Bryant
                    <br />
                    <b>Framework:</b> MUI Joy UI & React
                    <br />
                ...
                <Box>
                  <Typography
                    level="title-sm"
                    startDecorator={<Policy color="warning" />}
                    sx={{ mb: 1 }}
                  >
                    Licensing
                  </Typography>
                  <Typography level="body-xs" sx={{ lineHeight: 1.6 }}>
                    ...
                    <b>GNU General Public License v3.0 (GPL-3.0)</b>. In accordance with GPL
                    requirements:
                    <ul style={{ marginTop: '8px', paddingLeft: '20px' }}>
                      <li>
                        The full source code for this instance must be made available to users.
                      </li>
                      <li>
                        Modified versions must carry prominent notices stating that you changed the
                        files.
                      </li>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    ...
                    <Typography level="body-sm" sx={{ fontFamily: 'monospace', opacity: 0.7 }}>
                      {gitInfo.commitHash?.substring(0, 7) || 'DEV'}
                    </Typography>
                  </Box>
                </Stack>
              </Stack>
