...
export default function ProfileSettings() {
  const { user, onUpdateProfile, showNotification, isDark, api, household } = useHousehold();
    ...
    <Stack spacing={4} sx={{ maxWidth: 800 }}>
      ...
      <Box>
        ...
        <Sheet variant="outlined" sx={{ p: 3, borderRadius: 'md', bgcolor: 'background.level1' }}>
          <Stack direction="row" spacing={3} alignItems="center" sx={{ mb: 3 }}>
            ...
            <Box>
              ...
              <Typography level="body-xs" sx={{ mt: 1 }}>
                Click avatar to choose a custom emoji.
              </Typography>
            </Box>
          </Stack>
          ...
          <Button sx={{ mt: 3 }} loading={saving} onClick={handleSaveProfile}>
            Update Profile
          </Button>
        </Sheet>
      </Box>
        ...
        <Sheet variant="outlined" sx={{ borderRadius: 'md', overflow: 'hidden' }}>
          <List sx={{ '--ListItem-paddingY': '12px' }}>
            ...
            <ListItem>
              ...
              <Chip variant="soft" color="primary" size="sm" sx={{ textTransform: 'uppercase' }}>
                {user?.role}
              </Chip>
            </ListItem>
          </List>
            ...
            <Stack spacing={2} sx={{ mt: 1 }}>
              ...
              <FormControl required>
                ...
                <Select
                  ...
                  onChange={(_e, v) => setInviteData({ ...inviteData, role: v })}
                >
              ...
              <DialogActions>
                ...
                <Button variant="plain" color="neutral" onClick={() => setIsInviteModalOpen(false)}>
                  Cancel
                </Button>
              </DialogActions>
            </Stack>
      ...
      <Modal open={!!inviteSuccess} onClose={() => setInviteSuccess(null)}>
        <ModalDialog variant="outlined" role="alertdialog">
          ...
          <DialogContent>
            <Stack spacing={2}>
              <Typography>
                User <b>{inviteSuccess?.email}</b> has been added.
              </Typography>
          ...
          <DialogActions>
            <Button variant="solid" color="primary" onClick={() => setInviteSuccess(null)}>
              Done
            </Button>
          </DialogActions>
        </ModalDialog>
