    ...
    <Stack spacing={4}>
      <Box>
        ...
        <Typography level="body-sm">
          Personalize your workspace with Signature themes and adaptive display modes.
        </Typography>
      </Box>
      ...
      {/* Colour Section */}
      <Box>
        <Typography level="title-lg" startDecorator={<Palette color="primary" />} sx={{ mb: 3 }}>
          Colour Collection
        </Typography>
      ...
      <Box>
        <Typography level="title-lg" startDecorator={<Palette color="neutral" />} sx={{ mb: 2 }}>
          Laboratory
        </Typography>
        <Grid container spacing={2}>
          <Grid xs={6} sm={4} md={3}>
            ...
            >
              ...
              <Typography
                ...
                sx={{
                  fontSize: '13px',
                  color: themeId === 'custom' ? 'common.white' : 'text.primary',
                }}
              >
                Custom Theme
              </Typography>
      ...
      {themeId === 'custom' && (
        <Sheet
          variant="outlined"
          sx={{ p: 3, borderRadius: 'md', mb: 4, bgcolor: 'background.level1' }}
        >
          <Typography level="title-md" sx={{ mb: 2 }} startDecorator={<Palette color="primary" />}>
          ...
          <Grid container spacing={3}>
              ...
              <FormControl>
                ...
                <Stack direction="row" spacing={1}>
                  <input
                    ...
                    onChange={(e) =>
                      setCustomThemeConfig({ ...customThemeConfig, primary: e.target.value })
                    }
                    style={{
                      width: 40,
                      height: 40,
            ...
            <Grid xs={12}>
              <Button variant="solid" color="primary" onClick={handleSaveCustomTheme}>
                Save Custom Theme
              </Button>
            </Grid>
          </Grid>
