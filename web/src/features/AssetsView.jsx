              ...
              {processedAssets.map((row) => (
                ...
                >
                  <td>
                    <Avatar
                      size="sm"
                      sx={{ bgcolor: getEmojiColor(row.emoji || row.name[0], isDark) }}
                    >
                  ...
                  <td>
                    <Chip
                      ...
                      variant="soft"
                      color={
                        row.insurance_status === 'insured'
                          ? 'success'
                          : row.insurance_status === 'self-insured'
                            ? 'warning'
                            : 'danger'
                      }
                    >
              ...
              >
                ...
                <Box sx={{ flexGrow: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
                    ...
                    <Chip
                      size="sm"
                      color={a.insurance_status === 'insured' ? 'success' : 'neutral'}
                    >
