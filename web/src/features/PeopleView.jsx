...
export default function PeopleView() {
  ...
  const defaultValues = {
      ...
      first_name: '', middle_name: '', last_name: '', alias: '', dob: '', notes: ''
  };
  ...
  const FIELDS = [
    ...
    { name: 'type', label: 'Role / Type', type: 'select', options: [
  ...
  return (
    <GenericObjectView
        ...
        title={(data) => personId === 'new' ? `Add New ${data.type === 'child' ? 'Child' : 'Person'}` : (data.name || 'Person')}
        subtitle={personId === 'new' ? 'Enter personal details below.' : 'View and manage personal information.'}
    />
  );
}
