                ...
                <Box sx={{ flexGrow: 1 }}>
                  ...
                  <Stack spacing={0.5} mt={1}>
                    ...
                    {a.waste_provider && (
                      <Typography
                        level="body-xs"
                        startDecorator={<Opacity sx={{ fontSize: '0.8rem' }} />}
                      >
          ...
          <DialogContent>
            <form onSubmit={handleSubmit}>
              <Grid container spacing={2} sx={{ mt: 1 }}>
                ...
                <Grid xs={12}>
                  <Divider>Waste Water (if separate)</Divider>
                </Grid>
                <Grid xs={12} md={6}>
                  <FormControl>
                    ...
                    <Input
                      name="waste_provider"
                      defaultValue={editAccount?.waste_provider}
                      placeholder="Same as Supply"
                    />
                  </FormControl>
                </Grid>
                <Grid xs={12} md={6}>
                  <FormControl>
                    ...
                    <Input
                      name="waste_account_number"
                      defaultValue={editAccount?.waste_account_number}
                    />
                  </FormControl>
                </Grid>
