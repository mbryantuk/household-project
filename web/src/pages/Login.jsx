  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography level="h3" sx={{ fontWeight: 'xl', mb: 0.5, letterSpacing: '0.1em' }}>
        ...
        {message && (
          <Alert color="success" variant="soft" sx={{ mb: 3, textAlign: 'left' }}>
            {message}
          </Alert>
        )}
        {error && (
          <Alert color="danger" variant="soft" sx={{ mb: 3, textAlign: 'left' }}>
            {error}
          </Alert>
        )}
        ...
        {step === 1 ? (
          <form onSubmit={handleLookup}>
            <Typography level="h4" sx={{ mb: 1, textAlign: 'left' }}>
              Sign In
            </Typography>
            <Typography level="body-sm" sx={{ mb: 3, textAlign: 'left' }}>
            ...
            >
              <Checkbox
                ...
                size="sm"
              />
              <Link component={RouterLink} to="/register" level="body-sm" sx={{ fontWeight: 'lg' }}>
                Create Account
              </Link>
            </Stack>
          ...
          <form onSubmit={handleMfaSubmit}>
            ...
            <FormControl required sx={{ mb: 4 }}>
              ...
              <Input
                ...
                size="lg"
                slotProps={{
                  input: { textAlign: 'center', letterSpacing: '0.5em', fontWeight: 'bold' },
                }}
              />
            </FormControl>
