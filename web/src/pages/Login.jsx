    ...
    <Box sx={{ 
      ...
      >
        <Box sx={{ mb: 1, display: 'flex', justifyContent: 'center' }}>
            <HearthIcon colorway="default" sx={{ fontSize: 48 }} />
        </Box>
        <Typography level="h3" sx={{ fontWeight: 'xl', mb: 0.5, letterSpacing: '0.1em' }}>HEARTH</Typography>
        ...
        {step === 1 ? (
          <form onSubmit={handleLookup}>
            ...
            <Typography level="body-sm" sx={{ mb: 3, textAlign: 'left' }}>Use your Hearth account</Typography>
        ...
        <Box sx={{ mt: 4, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
            <Typography level="body-xs" color="neutral">
                &copy; {new Date().getFullYear()} Hearth Household Systems. All rights reserved.
            </Typography>
        </Box>
      </Sheet>
    </Box>
