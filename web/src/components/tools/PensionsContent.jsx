...
export default function PensionsContent({ api, householdId }) {
    ...
    >
      ...
      {selectedItem ? (
        <Box sx={{ textAlign: 'center', mb: 3 }}>
          <Typography level="body-xs" textTransform="uppercase" letterSpacing="1px" color="neutral">
            Current Value
          </Typography>
          ...
          <Typography level="body-sm" color="neutral">
            {selectedItem.provider} • {selectedItem.type}
          </Typography>
        </Box>
      ) : (
          ...
          <Card variant="soft" size="sm" sx={{ p: 2 }}>
            ...
            >
              ...
              <Box sx={{ display: 'flex', gap: 1 }}>
                <Button
                  ...
                  variant="outlined"
                  color="danger"
                  onClick={() => setAdjustItem({ item: selectedItem, type: 'remove' })}
                >
                  <Remove />
                </Button>
                <Button
                  ...
                  variant="outlined"
                  color="success"
                  onClick={() => setAdjustItem({ item: selectedItem, type: 'add' })}
                >
                  <Add />
                </Button>
              </Box>
            ...
            <Stack spacing={1}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Typography level="body-sm">£{selectedItem.monthly_contribution}/mo</Typography>
              </Box>
            </Stack>
          </Card>
        </Box>
      ...
      <Modal open={Boolean(adjustItem)} onClose={() => setAdjustItem(null)}>
        <ModalDialog size="sm">
          <DialogTitle>
            {adjustItem?.type === 'add' ? 'Increase Value' : 'Decrease Value'}
          </DialogTitle>
          <DialogContent>
            <form onSubmit={handleAdjustSubmit}>
              ...
              <Box sx={{ mt: 2, display: 'flex', justifyContent: 'flex-end', gap: 1 }}>
                <Button variant="plain" color="neutral" onClick={() => setAdjustItem(null)}>
                  Cancel
                </Button>
