...
import { Box, Sheet, Typography, IconButton } from '@mui/joy';
import { Close, DragIndicator, OpenInNew, HourglassBottom } from '@mui/icons-material';
import PensionsContent from './tools/PensionsContent';

export default function FloatingPensions({
  onClose,
  isPopout = false,
  isDark = false,
  isDocked = false,
