...
import { Box, Typography, Stack, CircularProgress, List, ListItem, ListItemContent, ListItemDecorator, LinearProgress } from '@mui/joy';
...
export default function CreditCardWidget({ api, household }) {
  ...
  if (loading) return <WidgetWrapper title="Credit Cards" icon={<CreditCard />} color="danger"><CircularProgress size="sm" /></WidgetWrapper>;
      ...
      <Stack spacing={2}>
        <Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                ...
                <Typography level="body-xs" fontWeight="bold">{Math.round(utilization)}%</Typography>
            </Box>
            <LinearProgress determinate value={utilization} color={utilization > 50 ? "danger" : "warning"} />
        </Box>
