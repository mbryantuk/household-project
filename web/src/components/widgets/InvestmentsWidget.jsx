...
export default function InvestmentsWidget({ api, household, data, onSaveData }) {
  ...
  const selectedItem =
    selectedId === 'total' ? null : investments.find((a) => a.id === parseInt(selectedId));
  ...
  const investedValue = selectedItem
    ? parseFloat(selectedItem.total_invested) || 0
    : totalInvestedAll;
