...
export default function FinancialCalculator({ onClose, onPopout, isPopout = false, isDocked = false }) {
  ...
  return (
    ...
    >
      <Box onMouseDown={onMouseDown} sx={{ p: 1, bgcolor: 'background.level2', display: 'flex', alignItems: 'center', cursor: isDocked ? 'default' : 'move' }}>
        ...
        <Typography level="title-sm" sx={{ flexGrow: 1 }}>Finance Calc</Typography>
