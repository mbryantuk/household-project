        ...
        <Box key={index} sx={{ mb: 4 }}>
          ...
          <Stack 
            ...
            sx={{ 
              ...
              mx: { xs: -2, md: 0 }, px: { xs: 2, md: 0 }, // Bleed to edge on mobile, contained on desktop
              scrollSnapType: 'x proximity',
              '&::-webkit-scrollbar': { height: '8px' },
              '&::-webkit-scrollbar-track': { background: 'transparent' },
              '&::-webkit-scrollbar-thumb': { background: 'var(--joy-palette-neutral-outlinedBorder)', borderRadius: '4px' },
          ...
          >
              ...
              <Box key={item.id || item.tempId} sx={{ minWidth: { xs: 140, sm: 160 }, width: { xs: 140, sm: 160 }, scrollSnapAlign: 'start' }}>
                ...
                >
                  <AspectRatio ratio="1" sx={{ width: '100%' }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 1, p: 2 }}>
                        {renderItem(item)}
                    </Box>
                  </AspectRatio>
                </Card>
            ...
            {/* Add Button Card */}
            {section.onAdd && (
              <Box sx={{ minWidth: { xs: 140, sm: 160 }, width: { xs: 140, sm: 160 }, scrollSnapAlign: 'start' }}>
                <Card 
                  variant="dashed" 
                  orientation="vertical"
                  sx={{ 
                ...
                >
                  <AspectRatio ratio="1" sx={{ width: '100%' }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
                        <IconButton size="lg" variant="solid" color="primary" sx={{ borderRadius: '50%' }}>
                            <Add />
                        </IconButton>
                        <Typography level="title-sm" color="primary">{section.addLabel || 'Add New'}</Typography>
                    </Box>
                  </AspectRatio>
                </Card>
              </Box>
