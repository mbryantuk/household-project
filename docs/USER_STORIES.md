...
- ⏳ **As a** user, **I want** to rearrange widgets on my dashboard, **so that** the most important info is where I want it.
...
- ⏳ **As a** user, **I want** recurring bills that fall on a weekend to automatically shift to the nearest working day on the calendar, **so that** I know the actual payment date. (Currently shifts forward instead of backward).
...
- ⏳ **As a** user, **I want** to track Investments (Stocks, Crypto) with unit counts and values, **so that** I can see my wider net worth. (Placeholder)
- ⏳ **As a** user, **I want** to track Pensions, **so that** I can plan for retirement. (Placeholder)

### Liabilities (Debts)
- ⏳ **As a** user, **I want** to track Credit Cards (Balance, Limit, APR), **so that** I can manage debt repayment. (Placeholder)
- ⏳ **As a** user, **I want** to track Loans and Mortgages, **so that** I have a complete picture of liabilities. (Placeholder)
...
- ⏳ **As a** user, **I want** to close a budget cycle, **so that** I can archive the month's performance and reset for the next. (API missing)
