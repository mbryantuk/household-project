...
_These rules prevent CLI freezing and looping._
...
- **Theming Rules:**
  ...
  4.  **Component Styling:** Use the `sx` prop or `styled()` from `@mui/joy/styles`.
...
_Use this logic when generating theme-aware components._
